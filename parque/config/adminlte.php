...
return [
    ...
    */
    ...
    'logo' => '<b>SGPE</b>INSTIC',
    'logo_img' => 'vendor/adminlte/dist/img/favicon-png.png',
    ...
    */
    ...
    'preloader' => [
        ...
        'mode' => 'fullscreen',
        'img' => [
            'path' => 'vendor/adminlte/dist/img/favicon-png.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active'  => ['admin/relatorio*'],
        ],
        
        
        ['header' => 'Ajustes do Sistema'],
        [
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.4.0/js/buttons.bootstrap.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.jsdelivr.net/npm/sweetalert2@11.26.17/dist/sweetalert2.all.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdn.jsdelivr.net/npm/sweetalert2@11.26.17/dist/sweetalert2.min.css',
                ],
            ],
        ],
        'Pace' => [
