...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Editar dados  de usuário: {{$usuario->name}}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/admin')}}">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{url('/admin/usuarios')}}">Lista de usuarios</a></li>
                <li class="breadcrumb-item"><a href="">Editar dados</a></li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nomes" value="{{ old('nomes', $usuario->nomes)}}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="apelidos" value="{{ old('apelidos', $usuario->apelidos)}}"
                                        placeholder=" Nomes" required>
                                </div>
                                @error('apelidos')
                                <small style="color: red">{{$message}}</small>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="tipo_documento" class="form-control" id="tipo_documento">
                                        ...
                                        <option value="BI" {{old('tipo_documento',$usuario->tipo_documento) == 'BI' ? 'selected' : ''}}>Bilhete
                                            de Identidade</option>
                                        <option value="Passaporte"
                                            {{old('tipo_documento',$usuario->tipo_documento) == 'Passaporte' ? 'selected' : ''}}>Passaporte
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="numero_documento"
                                        value="{{ old('numero_documento',$usuario->numero_documento)}}" placeholder=" Número do Documento"
                                        required>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="celular" value="{{ old('celular',$usuario->celular)}}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="genero" class="form-control" id="genero">
                                        ...
                                        <option value="Femenino" {{old('genero',$usuario->genero) == 'Femenino' ? 'selected' : ''}}>
                                            Femenino</option>
                                        <option value="Outro" {{old('genero',$usuario->genero) == 'Outro' ? 'selected' : ''}}>Outro
                                        </option>
                                    </select>
                                </div>
                                @error('genero')
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="direcao" value="{{ old('direcao',$usuario->direcao)}}"
                                        required>
                                </div>
                                @error('direcao')
                                <small style="color: red">{{$message}}</small>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_nome"
                                        value="{{ old('contacto_nome',$usuario->contacto_nome)}}" placeholder=" Nome do Contacto" required>
                                </div>
                                @error('contacto_nome')
                                <small style="color: red">{{$message}}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_telefone"
                                        value="{{ old('contacto_telefone', $usuario->contacto_telefone)}}" placeholder=" Número do Contacto"
                                        required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_parentesco"
                                        value="{{ old('contacto_parentesco', $usuario->contacto_parentesco)}}" placeholder=" Parentesco do Contacto"
                                        required>
                                </div>
