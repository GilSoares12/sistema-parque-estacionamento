        ...
        <div class="col-md-12">
            <div class="card card-primary ">
                <div class="card-header">
                    <h3 class="card-title"><b>Infomação Pessoal</b></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nomes"
                                                value="{{ old('nomes',$usuario->nomes)}}" placeholder=" Nomes" required>
                                        </div>
                                        @error('nomes')
                                        <small style="color: red">{{$message}}</small>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="apelidos"
                                                value="{{ old('apelidos',$usuario->apelidos)}}" placeholder=" Nomes"
                                                required>
                                        </div>
                                        @error('apelidos')
                                        <small style="color: red">{{$message}}</small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="tipo_documento" class="form-control" id="tipo_documento">
                                                ...
                                                <option value="BI"
                                                    {{old('tipo_documento',$usuario->tipo_documento) == 'BI' ? 'selected' : ''}}>
                                                    Bilhete
                                                    de Identidade</option>
                                                <option value="Passaporte"
                                                    {{old('tipo_documento',$usuario->tipo_documento) == 'Passaporte' ? 'selected' : ''}}>
                                                    Passaporte
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="celular"
                                                value="{{ old('celular',$usuario->celular)}}" placeholder=" Contacto"
                                                required>
                                        </div>
                                        @error('celular')
                                        <small style="color: red">{{$message}}</small>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="genero" class="form-control" id="genero">
                                                ...
                                                <option value="Femenino"
                                                    ...
                                                    Femenino</option>
                                                <option value="Outro"
                                                    {{old('genero',$usuario->genero) == 'Outro' ? 'selected' : ''}}>
                                                    Outro
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="direcao"
                                                value="{{ old('direcao',$usuario->direcao)}}" required>
                                        </div>
                                        @error('direcao')
                                        <small style="color: red">{{$message}}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="file" class="form-control" name="foto" id="foto"
                                                accept="image/*" onchange="mostrar_imagem(event)">

                                        </div>
                                        <center>
                                            @if(isset($usuario) && $usuario->foto)
                                            <img id="preview1" src="{{ asset('storage/fotos/'.$usuario->foto)}}" alt=""
                                                style="max-width:200px; margin-top:10px;">

                                            @else
                                            <img id="preview1" src="" alt="" style="max-width:200px; margin-top:10px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_nome"
                                        value="{{ old('contacto_nome',$usuario->contacto_nome)}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_telefone"
                                        value="{{ old('contacto_telefone',$usuario->contacto_telefone)}}"
                                        placeholder=" Número do Contacto" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contacto_parentesco"
                                        ...
                                        placeholder=" Parentesco do Contacto" required>
                                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-warning shadow-none">
                <div class="card-header">
                    <h3 class="card-title"><b>Segurança - Trocar a PalvraPass</b></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="password_atual">Senha Actual</label> 
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="password" class="form-control" name="password_atual"
                                     id="password_atual"   placeholder="Adicione a sua senha atual" >
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control" name="password_nova"
                                      id="password_nova"  placeholder="Adicione sua nova senha" >
                                </div>
                                @error('password_nova')
                                <small style="color: red">{{$message}}</small>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="password_confirmacao">Confirmar Nova Senha</label> 
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmacao"
                                     id="password_confirmacao"   placeholder="confirme sua nova senha" >
                                </div>
                                @error('password_confirmacao')
                                <small style="color: red">{{$message}}</small>
                                @enderror
                            </div>
                        </div>
