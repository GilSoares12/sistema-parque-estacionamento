        ...
        <div class="card card-outline card-primary ">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{url('/admin/clientes/create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Criar
                        novo</a>
                </div>
            </div>
            <!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="{{url('admin/cliente/' .$cliente->id)}}"
                                                class="btn btn-info btn-sm"><i class="fas fa-car">
                                                    Ver </i></a>
                                        <a href="{{url('admin/cliente/'.$cliente->id.'/edit')}}"
                                            ...
                                            <form action="{{url('admin/cliente/'.$cliente->id)}}" method="POST"
                                                id="meuformulario{{$cliente->id}}">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-danger btn-sm"
                                                    onclick="perguntar{{$cliente->id}}(event)"><i class="fas fa-trash-alt">
                                                        Eliminar</i></button>
                                            </form>
                                            <script>
                                            function perguntar{{$cliente->id}}(event){
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                       ...
                                                       document.getElementById('meuformulario{{ $cliente->id}}').submit();
                                                    }
                                                });
                                            }
                                            </script>
                                            @else
                                                <form action="{{url('admin/cliente/'.$cliente->id.'/restaurar')}}" method="POST"
                                                id="meuformulario{{$cliente->id}}">
                                                @csrf
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="perguntar{{$cliente->id}}(event)"><i class="fas fa-save">
                                                        Restaurar cliente</i></button>
                                            </form>
                                             <script>
                                            function perguntar{{$cliente->id}}(event){
                                                event.preventDefault();
                                                Swal.fire({
                                                    title: 'Deseja restaurar esse cliente?',
                                                    text: '',
                                                    icon: 'question',
                                                    showDenyButton: true,
