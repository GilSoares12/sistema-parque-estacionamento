            ...
            <div class="card-body">
                <form action="{{url('admin/cliente/'.$cliente->id)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nomes" value="{{ old('nomes', $cliente->nomes)}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="numero_documento"
                                        value="{{ old('numero_documento', $cliente->numero_documento)}}" placeholder=" Escreva  aqui..." required>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="email">Correio Electrónico</label> <b> (*)</b>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="tipo_cliente" class="form-control" id="tipo_cliente">
                                        ...
                                        <option value="Professor" {{old('tipo_cliente', $cliente->tipo_cliente) == 'Professor' ? 'selected' : ''}}>
                                        Professor</option>
                                        <option value="Estudante" {{old('tipo_cliente', $cliente->tipo_cliente) == 'Estudante' ? 'selected' : ''}}>
                                        Estudante</option>
                                        <option value="Funcionario" {{old('tipo_cliente', $cliente->tipo_cliente) == 'Funcionario' ? 'selected' : ''}}>Funcionario
                                        </option>
                                        <option value="Visitante" {{old('tipo_cliente', $cliente->tipo_cliente) == 'Visitante' ? 'selected' : ''}}>Visitante
                                        </option>
                                    </select>
                                </div>
                                @error('tipo_cliente')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="genero" class="form-control" id="genero">
                                        ...
                                        <option value="Femenino" {{old('genero', $cliente->genero) == 'Femenino' ? 'selected' : ''}}>
                                            Femenino</option>
                                        <option value="Outro" {{old('genero', $cliente->genero) == 'Outro' ? 'selected' : ''}}>Outro
                                        </option>
                                    </select>
                                </div>
                                @error('genero')
