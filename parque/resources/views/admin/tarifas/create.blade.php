...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Registro de uma nova tarifa</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="nome" class="form-control" id="nome" required>
                                        ...
                                        <option value="regular" {{old('nome') == 'regular' ? 'selected' : ''}}>
                                            Tarifa Regular</option>
                                        <option value="noturna" {{old('nome') == 'noturna' ? 'selected' : ''}}>
                                            Tarifa Noturna</option>
                                        <option value="final_de_semana"
                                            {{old('nome') == 'final_de_semana' ? 'selected' : ''}}>Final de Semana
                                        </option>
                                        <option value="feriados" {{old('nome') == 'feriados' ? 'selected' : ''}}>
                                            Feriados
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="tipo" class="form-control" id="tipo" required>
                                        ...
                                        <option value="por_hora" {{old('tipo') == 'por_hora' ? 'selected' : ''}}>
                                            Por Hora</option>
                                        <option value="por_dia" {{old('nome') == 'por_dia' ? 'selected' : ''}}>
                                            Por Dia</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="custo" id="custo" step="0.01"
                                        min="0" value="{{ old('custo')}}" required>
                                </div>
                                @error('custo')
                                <small style="color: red">{{$message}}</small>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        min="0"    value="{{ old('minutos_de_graca')}}" required>
                                    </div>
